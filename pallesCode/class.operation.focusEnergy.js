                    ...
                    if(Game.rooms[i]){
                        ...
                        if(Memory.operations[id].rooms[i].type == 'supply'){
                            if(room.terminal.store[RESOURCE_ENERGY]>5000){
                                room.terminal.send(RESOURCE_ENERGY,room.terminal.store[RESOURCE_ENERGY]-Game.market.calcTransactionCost(room.terminal.store[RESOURCE_ENERGY],i,room_focus),room_focus);
                            }
                        }
                    }
                }
