// Regenerates the flat goal layout src/construction/<family>.json from its planner
// export src/construction/source/<family>-rcl<N>.json. The source is a full RCL8
