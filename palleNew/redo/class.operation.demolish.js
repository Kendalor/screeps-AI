...
module.exports = class{
        ...
        static run(id){
			//if(Game.creeps["Alyssa"].signController(Game.creeps["Alyssa"].room.controller,"ALL YOUR BASE ARE BELONG TO US!")) Game.creeps["Alyssa"].moveTo(Game.creeps["Alyssa"].room.controller);
			...
			var creep_body = Array(30).fill(WORK,0,15).fill(MOVE,15,30);
